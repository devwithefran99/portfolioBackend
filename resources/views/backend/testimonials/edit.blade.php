...
@section('title', 'Edit Testimonial - Myfolio')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-1"><span class="text-muted fw-light">Testimonials /</span> Edit</h4>
            <p class="text-muted mb-0">Review সম্পাদনা করো</p>
        </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="rating"
                                           id="star{{ $s }}" value="{{ $s }}"
                                           {{ old('rating', $testimonial->rating) == $s ? 'checked' : '' }}>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="review" rows="4"
                                      class="form-control @error('review') is-invalid @enderror">{{ old('review', $testimonial->review) }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="upload-area border rounded-3 p-3 text-center position-relative"
                            ...
                            <p class="text-muted small mb-0 mt-1">নতুন photo দিতে ক্লিক করো</p>
                        </div>
                    </div>
                </div>
